...
exports.likeScream = (req, res) => {
    ...
    const screamDocumnet = db.doc(`/screams/${req.params.screamId}`);
            ...
            if (data.empty) {
                return db.collection('likes').add({
                    ...
                    .then(() => {
                        ...
                        return screamDocumnet.update({ likeCount: screamData.likeCount })
                    })
                    .then(() => {
                        return res.json(screamData)
                    })
...
exports.unlikeScream = (req, res) => {
    ...
    screamDocumnet.get()
        ...
        .then(data => {
            if (data.empty) {
                return res.status.json({ error: 'Scream already liked' })
            } else {
